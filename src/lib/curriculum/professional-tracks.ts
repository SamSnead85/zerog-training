...
export const productManagersTrack: ProfessionalTrack = {
    ...
    headline: "Stop Guessing. Start Leading. Become an AI-Native Product Manager.",
    tagline: "Master AI-powered product strategy and ship 10x faster with confidence",
    description: "The AI revolution demands a new kind of PM. While your competitors struggle to understand AI capabilities, you'll be building AI-first product strategies, collaborating fluently with data science teams, and using GenAI to automate research, documentation, and stakeholder communication. Based on the IBM AI Product Manager curriculum, this track transforms you from AI-curious to AI-native in 40-50 hours. Outcome: Ship AI-powered features 3x faster and own the AI product roadmap at your organization.",
    icon: "📊",
    color: "purple",
...
export const businessAnalystsTrack: ProfessionalTrack = {
    ...
    headline: "From Manual to Magical. Transform Your Analysis with AI.",
    tagline: "Deeper insights, automated discovery, and strategic recommendations that drive decisions",
    description: "Your stakeholders don't have time to wait for analysis. While traditional BAs spend days gathering requirements and building reports, AI-native analysts deliver insights in hours. This track teaches you to use AI for automated interview synthesis, predictive analytics, process mining, and data storytelling. Stop being order-takers—become strategic advisors who shape business direction. Outcome: Cut analysis time by 60% while delivering 2x the actionable insights.",
    icon: "📈",
    color: "emerald",
...
export const projectManagersTrack: ProfessionalTrack = {
    ...
    headline: "Your Projects on Autopilot. Risks Predicted. Teams Optimized.",
    tagline: "Predictive planning, automated status, and AI-powered risk management",
    description: "Stop drowning in status meetings and manual tracking. AI-native project managers use predictive analytics to forecast risks weeks before they materialize, automate resource optimization, and generate stakeholder reports in seconds. Based on PMI and Google project management best practices, this track transforms you from project administrator to strategic delivery leader. Outcome: Reduce project overhead by 40% while improving on-time delivery by 25%.",
    icon: "📋",
    color: "amber",
...
export const everyoneTrack: ProfessionalTrack = {
    ...
    headline: "AI Isn't Optional Anymore. Get Fluent in 12 Hours.",
    tagline: "The essential AI literacy every professional needs to thrive in the AI era",
    description: "AI is transforming every role, every industry, every company. Those who understand it will thrive; those who don't will be left behind. This foundational track is designed for ALL professionals—from marketing to HR to finance to operations. No coding required. In just 12-15 hours, you'll master prompt engineering, understand AI capabilities and limitations, use ChatGPT, Claude, and Gemini effectively, and navigate AI ethics confidently. Outcome: Go from AI-curious to AI-confident, ready to 2x your productivity in any role.",
    icon: "🌟",
    color: "blue",
