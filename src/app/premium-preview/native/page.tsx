...
export default function PremiumNativePage() {
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-black/50 backdrop-blur-xl">
                <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-8">
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        <Link href="/premium-preview/native" className="text-sm text-white hover:text-white transition-colors">
                            Framework
                        </Link>
                        <Link href="/premium-preview/platform" className="text-sm text-white/40 hover:text-white transition-colors">
                            Platform
                        </Link>
                        <Link href="/premium-preview/enterprise" className="text-sm text-white/40 hover:text-white transition-colors">
                            Enterprise
                        </Link>
                    </div>
