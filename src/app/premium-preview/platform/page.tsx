...
export default function PremiumPlatformPage() {
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 bg-black/50 backdrop-blur-xl">
                <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-8">
                    ...
                    <div className="hidden md:flex items-center gap-10">
                        ...
                        <Link href="/premium-preview/platform" className="text-sm text-white hover:text-white transition-colors">
                            Platform
                        </Link>
            ...
            <section className="relative pt-40 pb-24 px-8">
                ...
                <div className="relative z-10 mx-auto max-w-5xl text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8">
                        ...
                        <span className="text-sm text-white/60">AI-Native Training Platform</span>
                    </div>
