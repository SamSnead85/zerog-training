...
import { productManagersTrack, getTrackColor } from "@/lib/curriculum/professional-tracks";
...
const track = productManagersTrack;
        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="relative overflow-hidden py-20 px-4">
                ...
                <div className="relative max-w-6xl mx-auto">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="text-sm font-medium">Product Managers</span>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 mb-6">
                                ...
                                <span className="text-sm font-medium text-purple-500">Product Management Track</span>
                            </div>
            ...
            <section id="modules" className="py-16 px-4 bg-muted/30">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className="text-muted-foreground mb-8">
                        {track.modules.length} comprehensive modules designed for product management professionals
                    </p>
                        ...
                        {track.modules.map((module) => (
                            <Card key={module.id} className="p-6">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-purple-500/20 flex items-center justify-center text-lg font-bold text-purple-500">
                                        {module.number}
                                    </div>
                                    <div className="flex-1">
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    <Card className="p-8 border-purple-500/20 bg-gradient-to-br from-purple-500/5 to-transparent">
            ...
            {/* CTA */}
            <section className="py-16 px-4 bg-purple-500/10">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-4">Ready to Lead AI Products?</h2>
                    <p className="text-muted-foreground mb-8">
