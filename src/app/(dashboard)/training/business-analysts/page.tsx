...
import { businessAnalystsTrack } from "@/lib/curriculum/professional-tracks";
...
const track = businessAnalystsTrack;

export default function BusinessAnalystsPage() {
    return (
        <div className="min-h-screen bg-background">
            {/* Hero */}
            <section className="relative overflow-hidden py-20 px-4">
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-background" />
                ...
                <div className="relative max-w-6xl mx-auto">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="text-sm font-medium">Business Analysts</span>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-6">
                                ...
                                <span className="text-sm font-medium text-emerald-500">Business Analysis Track</span>
                            </div>
            ...
            <section id="modules" className="py-16 px-4 bg-muted/30">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className="text-muted-foreground mb-8">
                        {track.modules.length} comprehensive modules designed for business analysis professionals
                    </p>
                        ...
                        {track.modules.map((module) => (
                            <Card key={module.id} className="p-6">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-emerald-500/20 flex items-center justify-center text-lg font-bold text-emerald-500">
                                        {module.number}
                                    </div>
                                    <div className="flex-1">
            ...
            {/* CTA */}
            <section className="py-16 px-4 bg-emerald-500/10">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-4">Ready to Transform Your Analysis?</h2>
                    <p className="text-muted-foreground mb-8">
