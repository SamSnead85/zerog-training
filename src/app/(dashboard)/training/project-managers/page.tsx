...
import { projectManagersTrack } from "@/lib/curriculum/professional-tracks";
...
const track = projectManagersTrack;
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <section className="relative overflow-hidden py-20 px-4">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-background" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-amber-500/20 via-transparent to-transparent opacity-50" />
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 items-center">
                        <div className="flex-1">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6">
                                ...
                                <span className="text-sm font-medium text-amber-500">Project Management Track</span>
                            </div>
                        ...
                        <div className="w-full lg:w-80">
                            <Card className="p-6 border-amber-500/20">
                                ...
                                <p className="text-sm text-muted-foreground mb-4">
                                    Verify your skills with industry-recognized certification
                                </p>
                                <div className="space-y-2 text-sm">
                                    <div className="flex items-center gap-2">
                                        <CheckCircle2 className="h-4 w-4 text-amber-500" />
                                        <span>{track.modules.length} Expert Modules</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <CheckCircle2 className="h-4 w-4 text-amber-500" />
            ...
            <section id="modules" className="py-16 px-4 bg-muted/30">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className="text-muted-foreground mb-8">
                        {track.modules.length} comprehensive modules designed for project management professionals
                    </p>
                        ...
                        {track.modules.map((module) => (
                            <Card key={module.id} className="p-6">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-amber-500/20 flex items-center justify-center text-lg font-bold text-amber-500">
                                        {module.number}
                                    </div>
                                    <div className="flex-1">
            ...
            <section className="py-16 px-4">
                <div className="max-w-4xl mx-auto">
                    <Card className="p-8 border-amber-500/20 bg-gradient-to-br from-amber-500/5 to-transparent">
            ...
            {/* CTA */}
            <section className="py-16 px-4 bg-amber-500/10">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-bold mb-4">Ready to Deliver Smarter?</h2>
                    <p className="text-muted-foreground mb-8">
